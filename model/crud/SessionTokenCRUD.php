<?php 
    ...
    class SessionTokenCRUD {
        ...
        /**
         * Insert a session token in the table and return the result
         * 
         * @param object SessionToken object
         * @return bool if the session token is inserted or not
         */
        public static function insert(SessionToken $sessionToken):bool {
            $result = false;
            $db = Db::connect();
